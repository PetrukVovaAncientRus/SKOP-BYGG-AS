  ...
  return (
    <div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
        {/* Kontaktinfo panel */}
        <div className="md:col-span-5 space-y-6 bg-gray-50 p-8 rounded-xl border">
          <h2 className="text-xl font-bold text-brand-dark mb-4">Firmainformasjon</h2>
          <div className="space-y-4 text-sm text-gray-600">
            <div className="flex items-start gap-3">
              <MapPin className="text-brand-orange mt-1 shrink-0" size={18} />
              <span><strong>SKOP BYGG AS</strong><br />Kreklingveien 11, 3030 Drammen</span>
            </div>
            <div className="flex items-center gap-3">
              <Phone className="text-brand-orange" size={18} />
              <a href="tel:+47926197770" className="hover:underline">+47 926 197 770</a>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="md:col-span-7 bg-white border-4 border-neutral-300 rounded-xl shadow-xl relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-5 bg-[#fffdfa]">
            <div className="flex items-center gap-2 border-b border-gray-200 pb-3 mb-4">
              ...
              <h2 className="text-lg font-black uppercase text-gray-700 tracking-tight">Anbudsskjema / Forespørsel</h2>
            </div>
            ...
            >
              {status === 'loading' ? 'Sender forespørsel...' : (
            ...
            {status === 'success' && (
              <p className="text-emerald-700 bg-emerald-50 border border-emerald-200 p-3 rounded text-sm text-center font-bold">
                Takk! Din forespørsel er mottatt. Vi kontakter deg fortløpende for befaring.
              </p>
            )}
            {status === 'error' && (
